...
def main():
    ...
    subprocess.call("rm -rf /users/mgloud/projects/brain_gwas/output/rna-editing-tests-immune-bonus-diabetes/*", shell=True)

    kept_data = []
    with open("/users/mgloud/projects/rna_editing/output/complex/test-snps/rna-editing_full-immune-list.txt") as f:
        all_data = []
        f.readline()
        for line in f:
...
template = '''
{
        "out_dir_group": "rna-editing-tests-immune-bonus-diabetes",
