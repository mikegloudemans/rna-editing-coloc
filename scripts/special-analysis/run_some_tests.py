...
def main():
    ...
    important_diseases = ["/users/mgloud/projects/rna_editing/data/gwas/Primary-Sclerosing-Cholangitis_Ji_2017.txt.gz",
                            "/users/mgloud/projects/rna_editing/data/gwas/Rheumatoid-Arthritis_Okada_2014.txt.gz",
                            "/users/mgloud/projects/rna_editing/data/gwas/Rheumatoid-Arthritis_Stahl_2010.txt.gz",
                            "/users/mgloud/projects/rna_editing/data/gwas/Ulcerative-Colitis_Anderson_2011.txt.gz"]
    ...
    for i in range(len(kept_data)):
        ...
        if test[2] not in important_diseases:
            continue
        ...
        while int(subprocess.check_output('''ps -ef | grep "python /users/mgloud/projects/brain_gwas/scripts/dispatch.py /users/mgloud/projects/rna_editing/tmp/lc_config" | wc -l''', shell=True)) > 30:
            time.sleep(5)
