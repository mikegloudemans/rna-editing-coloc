...
#	echo -e "feature\tchr\tsnp_pos\tref\talt\tbuild\ttss_distance\tma_samples\tma_count\tmaf\tpvalue\tbeta\tse" > /users/mgloud/projects/brain_gwas/data/sqtls/gtex_v8/$f.sQTLs.txt
#	zcat /mnt/lab_data/montgomery/shared/datasets/gtex/GTEx_Analysis_2017-06-05_v8/sqtl/GTEx_Analysis_v8_sQTL_all_associations/$f | sed s/_/\\t/g | sed s/chr//g | tail -n +2 | sort -k2,2 -k3,3n >> /users/mgloud/projects/brain_gwas/data/sqtls/gtex_v8/$f.sQTLs.txt
#	bgzip -f /users/mgloud/projects/brain_gwas/data/sqtls/gtex_v8/$f.sQTLs.txt
#	tabix -f -S 1 -s 2 -b 3 -e 3 /users/mgloud/projects/brain_gwas/data/sqtls/gtex_v8/$f.sQTLs.txt.gz
#done
