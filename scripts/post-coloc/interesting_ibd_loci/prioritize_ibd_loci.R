...
# Load and clean data
gwas_hits = read.csv("/users/mgloud/projects/rna_editing/data/Huang2017GWAS-IBD.csv", header=TRUE)
...
write.table(bed_only, file="/users/mgloud/projects/rna_editing/tmp/bed_for_liftover.tmp", sep="\t", quote = FALSE, row.names=FALSE, col.names=FALSE)
system("liftOver /users/mgloud/projects/rna_editing/tmp/bed_for_liftover.tmp /mnt/lab_data/montgomery/shared/liftOver/chains/hg19ToHg38.over.chain.gz /users/mgloud/projects/rna_editing/output/liftover/Huang2017GWAS-IBD-lifted.bed /users/mgloud/projects/rna_editing/output/liftover/Huang2017GWAS-IBD-lifted-liftover-failed.bed")

lifted_gwas = read.table("/users/mgloud/projects/rna_editing/output/liftover/Huang2017GWAS-IBD-lifted.bed", header=FALSE)
...
hgnc = read.table("/users/mgloud/projects/insulin_resistance/scripts/auxiliary/eriks_bonus/eriks_grant/mart_export.txt", header=TRUE, fill=TRUE)
hgnc = hgnc[c("Gene","ID")]
